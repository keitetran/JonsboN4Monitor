...
#endif
#ifndef CONFIG_EXAMPLE_LVGL_PORT_PPA_ROTATION_ENABLE
#define CONFIG_EXAMPLE_LVGL_PORT_PPA_ROTATION_ENABLE 0
#endif
...
#define LVGL_PORT_TASK_MAX_DELAY_MS                                            \
  (CONFIG_EXAMPLE_LVGL_PORT_TASK_MAX_DELAY_MS) // The maximum delay of the LVGL
                                               // timer task, in milliseconds
#define LVGL_PORT_TASK_MIN_DELAY_MS                                            \
  (CONFIG_EXAMPLE_LVGL_PORT_TASK_MIN_DELAY_MS) // The minimum delay of the LVGL
                                               // timer task, in milliseconds
#define LVGL_PORT_TASK_STACK_SIZE                                              \
  (CONFIG_EXAMPLE_LVGL_PORT_TASK_STACK_SIZE_KB *                               \
   1024) // The stack size of the LVGL timer task, in bytes
#define LVGL_PORT_TASK_PRIORITY                                                \
  (CONFIG_EXAMPLE_LVGL_PORT_TASK_PRIORITY) // The priority of the LVGL timer
                                           // task
#define LVGL_PORT_TASK_CORE                                                    \
  (CONFIG_EXAMPLE_LVGL_PORT_TASK_CORE) // The core of the LVGL timer task,
 ...
 *
 */
#define LVGL_PORT_AVOID_TEAR_ENABLE                                            \
  (CONFIG_EXAMPLE_LVGL_PORT_AVOID_TEAR_ENABLE) // Set to 1 to enable
 ...
 *
 */
#define LVGL_PORT_PPA_ROTATION_ENABLE                                          \
  (CONFIG_EXAMPLE_LVGL_PORT_PPA_ROTATION_ENABLE)

/**
 * Set the rotation degree of the LCD panel when the avoid tearing function is
 * enabled:
 *      - 0: 0 degree
 *      - 90: 90 degree
 *      - 180: 180 degree
 ...
 *
 */
#define EXAMPLE_LVGL_PORT_ROTATION_DEGREE                                      \
  (CONFIG_EXAMPLE_LVGL_PORT_ROTATION_DEGREE)
